...
def OurModel(input_shape, action_space, dueling):
    ...
    if dueling:
        ...
        state_value = Lambda(lambda s: K.expand_dims(s[:, 0], -1), output_shape=(1, ))(state_value)

        action_advantage = Dense(action_space, kernel_initializer='he_uniform')(X)
        action_advantage = Lambda(lambda a: a[:, :] - K.mean(a[:, :], keepdims=True), output_shape=(1, ))(action_advantage)
